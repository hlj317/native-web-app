...
var AbstractView = require('AbstractView'),
    style = require('./list.css'),
    listTpl = require('./tpl.list.ejs'),
    StationEntity = require('./en.station'),
    DateEntity = require('./en.date'),
    TimeEntity = require('./en.time'),
    DateModule = require('./mod.date'),
    TimeModule = require('./mod.time'),
    SetoutModule = require('./mod.setout'),
    ArriveModule = require('./mod.arrive'),
    BusModel = require('../../model/bus.model'),
    layoutHtml = require('./tpl.layout.ejs'),
    searchBoxHtml = require('./tpl.search.box.ejs'),
    UIScrollLayer = require('UIScrollLayer');

var listPage = _.inherit(AbstractView, {
