...
var AbstractView = require('AbstractView'),
    ...
    BusStore = require('../../model/bus.store'),
    html = require('./city.ejs'),
    listTpl = require('./city.list.ejs'),
    searchTpl = require('./city.search.list.ejs'),
    style = require('./city.css');

var cityPage = _.inherit(AbstractView, {
