define(['AbstractView', '../../model/bus.model', '../../model/bus.store', './city.ejs', './city.list.ejs', './city.search.list.ejs', './city.css','underscore'
],
function (AbstractView, BusModel, BusStore, html, listTpl, searchTpl, style,_) {
