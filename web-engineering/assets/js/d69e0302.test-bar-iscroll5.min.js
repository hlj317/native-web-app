...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function(){
	    ...
	    myScroll.on("scrollEnd",function(){
	        i++;
	        var _x = this.x;
	        var _move = filterDis(_x);
	        this.x = _move;
	        $("#scroller").css("transition","-webkit-transform 300ms linear");
	        $("#scroller").css("-webkit-transform","translate("+_move+"px,0px) scale(1) translateZ(0px)");
	        //this._translate(filterDis(_x),0);

	        //$("#aa").html(window.navigator.userAgent);
