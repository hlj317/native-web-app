...
public class CollectActivity extends Activity {
	...
	private ListView collectList; // 最新文章列表
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.collect_title); // 自定义标题栏布局赋值
	...
	class articlelistThread implements Runnable {
		...
		public void run() {
			...
			if (result != null) {
				...
				Toast.makeText(CollectActivity.this, "网络异常，请检查您的网络", Toast.LENGTH_SHORT).show();
			}
			Looper.loop();
