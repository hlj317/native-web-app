...
public class PullToRefreshLayout extends RelativeLayout {
	...
	public void refreshFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			refreshStateImageView.setBackgroundResource(R.drawable.load_succeed2);
			break;
		case FAIL:
		default:
			// 刷新失败
			...
			refreshStateImageView.setBackgroundResource(R.drawable.load_failed2);
			break;
		}
		// 刷新结果停留1秒
		new Handler() {
	...
	public void loadmoreFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			loadStateImageView.setBackgroundResource(R.drawable.load_succeed2);
			break;  
		case LOAD_ALL:
			// 已全部加载
			loadStateImageView.setVisibility(View.VISIBLE);
		...
		default:
			...
			loadStateImageView.setBackgroundResource(R.drawable.load_failed2);
			break;
		} 
		// 刷新结果停留0.3秒
		new Handler() {
	...
	private void initView() {
		...
		loadingView = loadmoreView.findViewById(R.id.loading_icon2);
