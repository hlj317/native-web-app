...
public class MenuUtil {
	public final static String TAG = MenuUtil.class.getSimpleName();
	...
	public static boolean getExternalStoreState() {
		if (Environment.MEDIA_MOUNTED.equals(MenuUtil.getExternalStorageState()))
			return true;
		return false;
	}
