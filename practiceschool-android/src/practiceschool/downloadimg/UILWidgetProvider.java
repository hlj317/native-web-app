 ...
 *******************************************************************************/
package practiceschool.downloadimg;
...
public class UILWidgetProvider extends AppWidgetProvider {
	...
	static void updateAppWidget(Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
		...
		ImageLoader.getInstance().loadImage("http://120.55.99.230/public/upload/covers/loading.jpg", minImageSize, optionsWithFakeDisplayer, new SimpleImageLoadingListener() {
			@Override
